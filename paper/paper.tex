...
\begin{table}[t]
  ...
  \begin{tabular}{lP{1cm}P{1cm}P{1cm}P{1cm}P{1cm}P{1cm}P{1cm}P{1cm}P{1cm}}
    ...
    Adam ANN Backpropagation & \multicolumn{8}{c}{\(\alpha = 0.005, \beta_{1}=0.9,
                       \beta_{2}=0.999, \epsilon=10^{-8}, \lambda=0.001}\\ % OptAdam 0.005 0.9 0.999
% 1e-8 1e-3,
        Replay Memory Size & \multicolumn{8}{c}{\(10800\)}\\
    \bottomrule
  \end{tabular}
...
\MS[t]{TODO} As further comparison we implement the deep Q-Learning network algorithm proposed
