...
\begin{abstract}
  ...
  applications with high variability and periodic feedback to the agent. Therefore, this paper aims
  ...
  the commonly used deep Q-Learning algorithm. The results show that the both reinforcement learning
  agents have room for improvement for queuing systems with low variability, that our proposed
  method usually outperforms deep Q-Learning and finally for systems with high variability that the
  proposed reinforcement learning algorithm performs very well.
  %
