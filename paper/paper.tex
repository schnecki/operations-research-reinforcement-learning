...
is reinforcement learning \citep[e.g.][]{sutton1998introduction}, one of the main three subcategories of
machine learning. % It stems from dynamic programming the future
...
also seeks to compute the best stationary policy for a given
problem. % This policy is usually provided
