...
sum of the finished good inventory and backorder costs (FGIC+BOC) and the sum over all three cost
...
algorithm with discount factor \(0.99\) (\(\ql{0.99}\)), the \ARA{} algorithm with discount factors
\(0.99\) (\(\rl{0.99}\)) and \(1.00\) (\(\rl{1.00}\)), as well as the backward infinite loading
technique \BIL{} with fixed lead times between \(1\) and \(4\) as indicated by the number
($\BILOne$-$\BILFour$).


For the case of medium variability with a utilisation of \(70\%\) we can see that
